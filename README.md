...
This repository demonstrates an automated Infrastructure-as-Code (IaC) workflow designed for a scalable Kubernetes environment, inspired by the requirements of satellite data processing systems (e.g., EUMETSAT).
...
2. Initialize the cluster: `kind create cluster --name milad-for-eumetsat`
